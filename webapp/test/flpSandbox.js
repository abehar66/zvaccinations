		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#reportevacunacion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reportevacunacion-display": {
								"semanticObject": "reportevacunacion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reportevacunacion",
									"url": sap.ui.require.toUrl("reportevacunacion")
								}
							}
						}
					}
